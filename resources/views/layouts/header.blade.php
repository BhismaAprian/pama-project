            ...
            <div class="collapse navbar-collapse justify-content-between">
                ...
                <ul class="navbar-nav header-right main-notification">
                    ...
                    @php
                        ...
                        $history = RoomReservation::with('user', 'room')
                            ->take(7)
                            ->get();
                    @endphp
                    <li class="nav-item dropdown notification_dropdown">
                                            ...
                                            <div class="timeline-panel">
                                                <div class="media mr-2">
                                                    <img alt="image" width="50"
                                                        src="{{ asset('storage/thumbnails/' . $riwayat->room->thumbnail) }}">
                                                </div>
                                                <div class="media-body">
                                                    <h6 class="mb-1">{{ $riwayat->user->name ?? $riwayat->guest }}
                                                        Meminjam Ruangan {{ $riwayat->room->name }}</h6>
                                                    <small class="d-block">{{ $riwayat->reservation_start }} -
                                                        {{ $riwayat->reservation_end }}</small>
                                                </div>
                                            </div>
                                        </li>
                                    @endforeach
                    ...
                    @auth
                        ...
                        <li class="nav-item dropdown header-profile">
                            <a class="nav-link" href="#" role="button" data-toggle="dropdown">
                                <img src="https://jektvnews.disway.id/upload/caf20b7dd2137cf9ab9ce4a272dc5fae.png"
                                    width="20" alt="">
                    ...
                    @else
                        <div class="wrapped py-3 ms-2 me-2">
