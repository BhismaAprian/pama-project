                    ...
                    <div class="basic-form">
                        <form method="POST" action="{{route('attributes.update', $attribute->id)}}" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="name" value="{{$attribute->name}}" name="name" class="form-control" placeholder="Nama Barang">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-3 col-form-label">Deskripsi Barang</label>
                                <textarea class="form-control" value="{{$attribute->description}}" name="description" rows="4" id="comment"></textarea>
