...
@section('content')
    <div class="container-fluid">
        <div class="form-head d-flex align-items-center flex-wrap mb-sm-5 mb-3">
            ...
            <a href="{{ route('attributes.create') }}" class="btn btn-outline-secondary ml-auto"><i
                    class="las la-calendar scale5 mr-2"></i>Buat Barang</a>
        </div>
        <div class="row">
                    ...
                    <div class="card-body  p-4">
                        <div class="media">
                            ...
                            <div class="media-body text-white">
                                ...
                                <h3 class="text-white">{{ $totalbarang }}</h3>
                ...
                <div class="widget-stat card bg-primary">
                    <div class="card-body  p-4">
                        <div class="media">
                            ...
                            <div class="media-body text-white">
                                <p class="mb-1">Total Barang Yang Tersedia</p>
                                <h3 class="text-white">{{ $barangSedia->sum('qty_sedia') }}</h3>
                        ...
                        <table class="table display mb-4 dataTablesCard short-one card-table text-black" id="example3">
                            <thead>
                                <tr>
                                    <th>ID</th>
                                    <th>Nama Attribut</th>
                                    <th>Jumlah Attribut</th>
                                    <th>Jumlah Attribut yang tersedia</th>
                                    <th>Deskripsi</th>
                                    <th>Aksi</th>
                                </tr>
                            </thead>
