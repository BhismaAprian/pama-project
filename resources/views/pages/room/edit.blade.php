                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="basic-form">
                            <form method="POST" action="{{ route('rooms.update', $room->id) }}"
                                ...
                                <div class="image-placeholder">
                                    ...
                                    <div class="avatar-preview rounded">
                                        <div id="imagePreview" class="rounded"
                                            style="background-image: url('{{ asset('storage/thumbnails/' . $room->thumbnail) }}');">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="contact-name">
                                        <input type="name" name="name" value="{{ $room->name }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="contact-occupation">
                                        <textarea class="form-control" name="description" rows="4" id="comment">{{ old('description', $room->description) }}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-9">
                                    <input type="name" name="name" class="form-control" value="{{$room->name}}" placeholder="Nama Ruangan">
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                <label class="col-sm-3 col-form-label">Deskripsi Ruangan</label>
                                <textarea class="form-control" value="{{$room->description}}" name="description" rows="4" id="comment"></textarea>
